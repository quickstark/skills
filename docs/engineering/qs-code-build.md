...
- [`/qs-code-document`](https://github.com/quickstark/skills/blob/main/skills/engineering/qs-code-document/SKILL.md) — Document the verified implementation, changed files, and operational behavior.
