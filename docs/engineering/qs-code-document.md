...
The default ranked continuations are `/qs-review-code`, `/qs-git-merge`, `/qs-flow-handoff`. Failed results instead rank `/qs-code-debug`, `/qs-review-code`, `/qs-flow-handoff`.
