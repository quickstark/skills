...
- `/qs-test-tdd` — Protect the selected module seam with a behavior-first test.
- `/qs-plan-spec` — Document a significant interface or refactoring decision.
- `/qs-code-build` — Implement the agreed module design.
