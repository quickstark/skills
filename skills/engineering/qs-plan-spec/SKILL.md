...
Skills used: /qs-plan-spec; /another-skill only if actually used
...
- `/qs-plan-tickets` — Break a substantial specification into dependency-aware work.
- `/qs-code-build` — Implement a small, sufficiently clear specification directly.
- `/qs-design-modules` — Resolve an important interface or module boundary before implementation.
