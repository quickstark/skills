...
export const REPORT_PRESENTATION_STYLES = `
  ...
  @media(max-width:1080px){.compact-readout .next-grid,.workbench-readout-document .next-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.presentation-project-bar{grid-template-columns:repeat(4,minmax(0,1fr))}.presentation-project-fact:nth-child(4){border-right:0}.presentation-project-fact:nth-child(n+5){border-top:1px solid var(--line)}}
  ...
  @media(max-width:620px){.presentation-project-bar{grid-template-columns:repeat(2,minmax(0,1fr))}.presentation-project-fact:nth-child(2n){border-right:0}.presentation-project-fact:nth-child(n+3){border-top:1px solid var(--line)}.presentation-summary-metrics{grid-template-columns:repeat(2,minmax(0,1fr))}.workbench-shell.has-issue-sidebar{grid-template-columns:1fr;grid-template-rows:auto auto auto auto}.workbench-shell.has-issue-sidebar>.workbench-issues{grid-column:1;grid-row:4;max-height:none}}
`;
